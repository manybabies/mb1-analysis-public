...
Note that `subid` is not unqiue except within lab, this will compromise our regression models in the final paper [issue](https://github.com/manybabies/mb1-analysis-public/issues/8). We fix this here. 

```{r}
d$subid <- str_c(d$lab, "-", d$subid)
```
